...
public class MembersController extends HttpServlet {
  ...
  /*private String readFile(String filename) {
    ...
    public void htmlUpdate(PrintWriter out, HttpServletRequest request, Members member) {
        ...
        out.println("<input type='text' minlength='2' maxlength='24' id='firstName' name='firstName' value='" + member.getFirst_name() + "'>");
        out.println("</div>");

        out.println("<div>");
        out.println("<h3>Last Name</h3>");
        out.println("<input type='text' minlength='2' maxlength='24' id='lastName' name='lastName' value='" + member.getLast_name() + "'>");
        out.println("</div>");

        //out.println("label for=\"email\">email:</label><br>");
        out.println("<div>");
        out.println("<h3>Email</h3>");
        out.println("<input type='email' id='email' name='email' value='" + member.getEmail() + "'>");
        out.println("</div>");
    ...
    private void htmlListMembers(PrintWriter out, List < Members > allMembers) throws SQLException {
        ...
        if (allMembers != null) {
            for (Members member: allMembers) {
                ...
                out.println("<td>");
                out.println("<form action=/borrow_returns method=get>");

                out.println("<input type=hidden name=memberId value=" + member.getMember_id() + ">");
                out.println("<button type=submit>Borrow/Returns</button>");
                out.println("</form>");
                out.println("</td>");
                ...
                out.println("<form action=/members/delete method=post>");
                out.println("<input type=hidden name=memberId value=" + member.getMember_id() + ">");
                out.println("<button type=submit> Fines </button>");
                out.println("</form>");
                out.println("</td>");
    ...
    public void htmlAddMember(PrintWriter out, HttpServletRequest request) {
        ...
        //out.println("label for=\"firstName\">First name:</label><br>");
        out.println("<input type='text' minlength='2' maxlength='24' id='firstName' name='firstName' value='" + "'>");
        out.println("</div>");

        out.println("<div>");
        out.println("<h3>Last Name</h3>");
        out.println("<input type='text' minlength='2' maxlength='24' id='lastName' name='lastName' value='" + "'>");
        out.println("</div>");
