...
public class BooksController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (pathInfo == null || "/".equals(pathInfo)) {
            try {
                ...
                htmlListMembers(out, allBooks, request);
  ...
  /*private String readFile(String filename) {
    ...
    public void htmlUpdate(PrintWriter out, HttpServletRequest request, Books book) {
        ...
        out.println("<input type='text' minlength='2' id='title' name='title' value='" + book.getTitle() + "'>");
        out.println("</div>");

        out.println("<div>");
        out.println("<h3>Author</h3>");
        out.println("<input type='text' minlength='2' maxlength='24' id='author' name='author' value='" + book.getAuthor() + "'>");
        out.println("</div>");
...
/////
        ...
        out.println("<input type='text' minlength='2' maxlength='24' id='publisher' name='publisher' value='" + book.getPublisher() + "'>");
        out.println("</div>");
    ...
    private void htmlListMembers(PrintWriter out, List<Books> allBooks, HttpServletRequest request) {
        ...
        if (allBooks != null) {
            for (Books book: allBooks) {
                ...
                out.println("<td>");
                // TODO... Fix path creation or double check
                out.println("<form action=/borrow_returns/checkout?bookId=" + book.getBook_id()+ "method=post>");
                out.println("<input type=hidden name=bookId value=" + book.getBook_id() + ">");
    ...
    public void htmlAddBook(PrintWriter out, HttpServletRequest request) {
        ...
        //out.println("label for=\"firstName\">First name:</label><br>");
        out.println("<input type='text' minlength='2' maxlength='24' id='title' name='title' value='" + "'>");
        out.println("</div>");

        out.println("<div>");
        out.println("<h3>Author</h3>");
        out.println("<input type='text' minlength='2' maxlength='24' id='author' name='author' value='" + "'>");
        out.println("</div>");
        ...
        out.println("<div>");
        out.println("<h3>Publisher</h3>");
        out.println("<input type='text' minlength='2' maxlength='24' id='publisher' name='publisher' value='" + "'>");
        out.println("</div>");
